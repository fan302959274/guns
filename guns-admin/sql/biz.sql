...
CREATE TABLE `pk_ad` (
	...
	`ad_main_head` VARCHAR (256) DEFAULT NULL COMMENT '广告主标题',
	`ad_sub_head` VARCHAR (256) DEFAULT NULL COMMENT '广告副标题',
	`ad_start_time` datetime  DEFAULT NULL COMMENT '开始时间',
	`ad_end_time` datetime  DEFAULT NULL COMMENT '结束时间',
	`ad_url` VARCHAR (1000) DEFAULT NULL COMMENT '广告链接',
	`ad_status` VARCHAR (1) DEFAULT NULL COMMENT '广告状态:0:预上线;1:已上线',
	...
	PRIMARY KEY (`id`)
) ENGINE = INNODB AUTO_INCREMENT = 15 DEFAULT CHARSET = utf8 COMMENT = '广告表';
...
CREATE TABLE `pk_member` (
	...
	`member_birth` datetime  DEFAULT NULL COMMENT '出生年月',
	...
	`member_status` VARCHAR (1) DEFAULT '0' COMMENT '队员状态:0:禁用1:启用',
	`create_date` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
	`update_date` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
	`creator` VARCHAR (100) DEFAULT NULL COMMENT '创建人',
	`updator` VARCHAR (100) DEFAULT NULL COMMENT '更新人',
...
`id` BIGINT (11) NOT NULL AUTO_INCREMENT COMMENT '主键',
`team_name` VARCHAR (50) DEFAULT NULL COMMENT '球队名称',
`team_level` VARCHAR (20) DEFAULT NULL COMMENT '球队级别',
...
`team_province` VARCHAR (20) DEFAULT NULL COMMENT '球队省份',
`team_city` VARCHAR (20) DEFAULT NULL COMMENT '球队市',
`team_area` VARCHAR (20) DEFAULT NULL COMMENT '球队区',
`team_member_desc` VARCHAR (256) DEFAULT NULL COMMENT '球队描述',
`team_owner_id` BIGINT (11) NOT NULL COMMENT '所属人',
`team_status` VARCHAR (10) DEFAULT '0' COMMENT '球队状态:0:禁用1:启用',
`create_date` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
`update_date` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
`creator` VARCHAR (100) DEFAULT NULL COMMENT '创建人',
`updator` VARCHAR (100) DEFAULT NULL COMMENT '更新人',
...
`id` BIGINT (11) NOT NULL AUTO_INCREMENT COMMENT '主键',
`match_name` VARCHAR (50) DEFAULT NULL COMMENT '比赛名称',
`match_time` INTEGER DEFAULT NULL COMMENT '比赛时间',
`match_place` VARCHAR (256) DEFAULT NULL COMMENT '比赛地点',
`match_initiator_id` VARCHAR (256) NOT NULL COMMENT '比赛发起人',
`match_host_team_id` BIGINT (11) NOT NULL COMMENT '东道主team',
`match_challenge_team_id` BIGINT (11) DEFAULT NULL COMMENT '挑战team',
`match_province` VARCHAR (20) DEFAULT NULL COMMENT '比赛省份',
`match_city` VARCHAR (20) DEFAULT NULL COMMENT '比赛市',
`match_area` VARCHAR (20) DEFAULT NULL COMMENT '比赛区',
...
`id` BIGINT (11) NOT NULL AUTO_INCREMENT COMMENT '主键',
`park_name` VARCHAR (50) DEFAULT NULL COMMENT '球场名称',
`park_province` VARCHAR (20) DEFAULT NULL COMMENT '球场省份',
`park_city` VARCHAR (20) DEFAULT NULL COMMENT '球场市',
`park_area` VARCHAR (20) DEFAULT NULL COMMENT '球场区',
`park_desc` VARCHAR (200) DEFAULT NULL COMMENT '球场简介',
...
CREATE TABLE `pk_attachment` (
	...
	`attachment_type` VARCHAR (3) NOT NULL COMMENT '附件类型1:队员附件;2:球队附件;3:球场附件;4:广告附件',
	`attachment_key` VARCHAR (40) NOT NULL COMMENT '关联主键:队员id|球队id|球场id|广告id',
	`attachment_suffix` VARCHAR (500) DEFAULT NULL COMMENT '附件后缀',
	`create_date` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
	`update_date` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
	`creator` VARCHAR (100) DEFAULT NULL COMMENT '创建人',
	`updator` VARCHAR (100) DEFAULT NULL COMMENT '更新人',
